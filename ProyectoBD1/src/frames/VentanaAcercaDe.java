...
public class VentanaAcercaDe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Informacion Acerca de la Aplicacion");

        jLabel2.setText("Autores:");

        jLabel3.setText("Gerald Morales Alvarado");

        jLabel4.setText("Marlon Reyes Montero");

        jLabel5.setText("Version 1.0");

        jLabel6.setText("Interprete de Álgebra Relacional");

        jLabel7.setText("Fecha de creacion: 8-10-17");
