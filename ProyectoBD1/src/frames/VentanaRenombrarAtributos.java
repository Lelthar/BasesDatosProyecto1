...
public class VentanaRenombrarAtributos extends javax.swing.JFrame {
     ...
     */
    public VentanaRenombrarAtributos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaRenombrarAtributos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaRenombrarAtributos().setVisible(true);
            }
        });
    }
