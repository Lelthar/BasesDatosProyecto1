 ...
 * @author mailon2
 */
public class VentanaDivision extends javax.swing.JFrame {
    
    OperacionesAlgebraRelacional ventanaMain;
    /**
     * Creates new form VentanaProductoCartesiano
     */
    public VentanaDivision() {
        initComponents();
    }
    
    public VentanaDivision(OperacionesAlgebraRelacional ventana){
        initComponents();
                ...
                if(Singleton.getInstance().getConexionServidor().existeTablaP(jTextFieldTabla1.getText())){
                    if(Singleton.getInstance().getConexionServidor().existeTablaP(jTextFieldTabla2.getText())){
                        ...
                        (Singleton.getInstance().getConexionServidor().esTablaTemporalP(jTextFieldResul.getText()) != true)){
                            ...
                            if(Singleton.getInstance().getConexionServidor().validarAtributosVec(jTextFieldTabla1.getText(), jTextFieldTabla2.getText())){
                                try {
                                    String nombreTabla1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaDivision.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new VentanaDivision().setVisible(true);
        });
    }
