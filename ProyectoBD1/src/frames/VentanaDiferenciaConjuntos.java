...
public class VentanaDiferenciaConjuntos extends javax.swing.JFrame {
     ...
     */
    public VentanaDiferenciaConjuntos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaDiferenciaConjuntos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaDiferenciaConjuntos().setVisible(true);
            }
        });
    }
